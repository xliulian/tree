...
var Tree = /*#__PURE__*/function (_React$Component) {
  ...
  function Tree() {
    ...
    _this.throttleOnNodeDragOver = void 0;
    ...
    _this.queueDragEvent = function (handler, event, node) {
      ...
      if (handler === _this.onNodeDragLeave) {
    ...
    _this.processDragEvents = function () {
      ...
      while (_this.dragEventQueue.length > 0) {
        ...
        if (!event.currentTarget && !event.target.classList.contains("".concat(_this.props.prefixCls, "-treenode"))) {
          event.currentTarget = event.target.closest(".".concat(_this.props.prefixCls, "-treenode"));
        }
  ...
  (0, _createClass2.default)(Tree, [{
    ...
    value: function componentDidMount() {
      this.throttleOnNodeDragOver = (0, _throttle.default)(this.onNodeDragOver.bind(this), 200, {
        trailing: false
      });
      this.onUpdated();
    }
